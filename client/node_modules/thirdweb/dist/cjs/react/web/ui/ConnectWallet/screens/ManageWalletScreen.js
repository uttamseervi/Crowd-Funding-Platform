...
function ManageWalletScreen(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { style: {
            minHeight: "300px",
                    ...
                    maxHeight: "500px",
                }, children: [(0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "md" }), (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { style: { position: "relative", height: "250px" }, children: [(0, jsx_runtime_1.jsx)(SwitchMetamaskAccount, { closeModal: props.closeModal, connectLocale: props.locale }), typeof activeWallet !== "undefined" &&
